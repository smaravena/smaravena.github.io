...
window.addEventListener("DOMContentLoaded", (event) => {
  ...
  if (isMobile) {
    ctaContainer.innerHTML = `<a href="https://github.com/MatiasGonzalezPizarro/Upliftly/releases" class="bg-tertiary text-white py-3 px-6 rounded-md text-lg hover:bg-primary transition flex items-center justify-center">
